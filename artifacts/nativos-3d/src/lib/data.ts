...
export const products: Product[] = [
  {
    ...
    description:
      "Vaso de parede com geometria hexagonal de alto relevo. Design moderno que transforma qualquer ambiente com textura e profundidade.",
    details: [
  ...
  },
  {
    ...
    description:
      "Mandala com camadas sobrepostas que criam profundidade e volume na parede. Arte funcional para qualquer espaco.",
    details: [
      "Diametro: 40 cm",
  ...
  },
  {
    ...
    description:
      "Acabou a bagunca de cabos! Organizador de mesa com encaixes para ate 6 cabos simultaneamente. Mesa sempre limpa e organizada.",
    details: [
  ...
  },
  {
    ...
    description:
      "Par de porta-livros com design geometrico de alto relevo. Funcionais e decorativos ao mesmo tempo, personalizam qualquer prateleira.",
    details: [
      "Par com 2 unidades",
  ...
  },
  {
    ...
    description:
      "Dragao articulado com 47 juntas moveis, confeccionado com maxima precisao. Flexivel e resistente, uma obra de arte mecanica unica.",
    details: [
